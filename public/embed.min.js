...
font-size: 62.5%
  ...
  #my-ai-chatbot{position:fixed;bottom:20px;right:20px;width:45rem;height:85%;background:var(--bg-chat);color:var(--text-light);border-radius:1rem;box-shadow:0 0 15px rgba(0,0,0,0.5);display:flex;flex-direction:column;overflow:hidden;font-family:sans-serif;z-index:99999;border:0px solid var(--border-chat);transform:scale(0);transform-origin:bottom right;transition:transform 0.3s ease-in-out;}
